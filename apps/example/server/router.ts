...
const wrapper = async (req: NextApiRequest, res: NextApiResponse, handler: Handler): Promise<void> => {
  await handler(req, res);
};

const myRouter = <BODY = undefined, QUERY = undefined>(): Router<Handler> => router<Handler>(wrapper);
